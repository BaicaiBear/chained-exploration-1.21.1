                        ...
                        .executes(context -> {
                            ...
                            if (source.getEntity() instanceof ServerPlayerEntity player) {
                                ...
                                if (CETeamManager.createOrJoinTeam(player, targetPlayer)) {
                                    return sendSuccessFeedback(source, "成功加入队伍: " + targetPlayer.getName().getString());
                                } else {
                                    return sendErrorFeedback(source, "无法加入队伍: 目标玩家不存在或已达到队伍人数限制");
                                }
                            }
                            return 0;
                        })
                        ...
                        .executes(context -> {
                            ...
                            if (source.getEntity() instanceof ServerPlayerEntity player) {
                                ...
                                if (CETeamManager.removeMember(targetPlayer, player)) {
                                    return sendSuccessFeedback(source, "成功移除队员: " + targetPlayer.getName().getString());
                                } else {
